...
const ArrowButton = ({ onClick, icon, className }: any) => (
...
const Slider = ({ options, children, prevIcon, nextIcon, className }: any) => {
  const settings = {
    dots: false,
    arrows: false,
    infinite: false,
...
export const SliderItem = ({ children, className, ...rest }: any) => (
