          ...
          <div className="rn-support-read">
            ...
            <div className="read-card">
              ...
              <div className="content">
                <p>
                  All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as
                  necessary, making this the first true generator on the Internet. Various versions
            ...
            <Button path="/contact" color="primary-alta">
              Contact Us
            </Button>
          </div>
        </div>
          ...
          <div className="support-accordion">
            <Accordion
              ...
              items={[
                ...
                {
                  id: 5,
                  title: 'Okay, I am afraid to ask but... what is SEO?',
                  description:
                    '<strong>This is the first items accordion body.</strong> It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It is also worth noting that just about any HTML can go within the, though the transition does limit overflow.',
                },
              ]}
